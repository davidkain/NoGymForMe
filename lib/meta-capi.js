...
/**
 * Every pixel we should report to, resolved from process.env on each call.
 *
 * IMPORTANT: Vercel bakes env vars into a DEPLOYMENT. Editing META_PIXEL_ID_2 /
 * META_CAPI_TOKEN_2 in the dashboard does NOT reach already-running functions —
 * you must REDEPLOY for the change to take effect. Symptom if you forget: CAPI
 * silently keeps the old single-pixel behaviour with no error to explain why.
 *
